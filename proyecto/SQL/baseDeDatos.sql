...
INSERT INTO tabla_de_usuarios (id, email, usuario, contraseña, fecha_de_nacimiento, documento, foto_perfil)
...
(default, "6", "/images/products/pastafrola.jpg", "Pasta frola de membrillo", "La pasta frola de membrillo se elabora con ingredientes simples como harina, mantequilla, azúcar, huevos y dulce de membrillo.", "31-03-23"),
(default, "7", "/images/products/ricota.jpg", "Torta de Ricota", "La torta de ricota es un postre italiano elaborado con queso ricota, huevos, azúcar, harina y esencia de vainilla.", "31-03-23"),
(default, "8", "/images/products/marquise.jpg", "Marquise", "La marquise es un postre de origen francés elaborado con chocolate, mantequilla, huevos y azúcar.", "31-03-23"),
(default, "9", "/images/products/tiramisu.jpg", "Tiramisú", "El tiramisú es un postre italiano que se elabora con ingredientes simples como queso mascarpone, bizcochos de soletilla, café, huevos y cacao en polvo.", "31-03-23"),
(default, "10", "/images/products/tortachocolate.jpg", "Torta de chocolate", "La torta de chocolate es un postre clásico que se elabora con ingredientes simples como harina, azúcar, huevos, mantequilla, chocolate y cacao en polvo.", "31-03-23");
